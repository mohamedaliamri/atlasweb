	...
	<aside
		...
		<div class="sidenav-header">
			<i
				...
				class="ms-1 font-weight-bold text-white">Menu</span>
			</a>
		</div>
					...
					href="../pages/dashboard.jsp">
						<div
							...
							<i class="material-icons opacity-10">dashboard</i>
								...
								<li class="nav-item">
								<form role="form" method="get" action="http://localhost:8080/atlasweb/add">
								
								
								<a class="nav-link text-white "

					href="http://localhost:8080/atlasweb/add?Hello" >
				...
				<div class="col-lg-12 col-md-12">
				 <form role="form" method="post" action="http://localhost:8080/atlasweb/add">
					<div class="card h-100">
						...
						<div class="row">
							<div class="card-body p-3 col-lg-4">
								<div class="card-body">
							...
							<div class="card-body p-3 col-lg-4">
								<div class="card-body">
									<div class="input-group input-group-outline mb-3">
										<label class="form-label"></label> <input type="date"
						...
						<div class="card-header pb-3">
							<h6>Nous allons programmer les bracelets un à un ensemble.
