            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                  ...
                  <div class="form-check form-switch d-flex align-items-center mb-3">
                    ...
                    <label class="form-check-label mb-0 ms-2" for="rememberMe">Souviens-toi de moi</label>
                  </div>
                  <%
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2" name="method" value="signin">S'identifier</button>
                  </div>
                  <p class="mt-4 text-sm text-center">
                   Vous n'avez pas de compte ?
                    <a href="../pages/sign-up.jsp" class="text-primary text-gradient font-weight-bold"> S'inscrire</a>
                  </p>
                </form>
              </div>
            </div>
