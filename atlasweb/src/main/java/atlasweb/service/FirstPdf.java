...
public class FirstPdf {
    ...
    public  void addTitlePage(Document document, Bracelet bracelet)
        ...
        //ImageIO.write(generateEAN13BarcodeImage(String.valueOf(id)), "png", baos);
